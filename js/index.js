const SITE_BASE = document.querySelector('meta[name="site-baseurl"]')?.content || "";
/**
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (zoomImgs.length > 0) {
      ...
      loadCSS(SITE_BASE + "/css/photoswipe.css" + assetV);

      loadScript(SITE_BASE + "/js/photoswipe.umd.min.js" + assetV, function () {
        loadScript(SITE_BASE + "/js/photoswipe-lightbox.umd.min.js" + assetV, function () {
